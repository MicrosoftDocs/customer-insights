...
## [Create your own metrics](xref:developers/quick-starts/2_create-own-metrics)
### [1. Collect more signals](xref:developers/quick-starts/2_1_collect)
### [2. Create a metric](xref:developers/quick-starts/2_2_create)
...
## [Publish and share](xref:developers/quick-starts/3_publish-share)
