...
4. You can now select your newly created project from the **Projects** menu and get a copy of its ingestion key, as described in [Get an API token](api-token.md).
