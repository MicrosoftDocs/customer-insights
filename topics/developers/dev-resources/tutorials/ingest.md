...
You can find the ingestion key for your Product Insights tenant on its settings page. [Here is how to find and copy your key.](topics/developers/downloads/api-token.md)
