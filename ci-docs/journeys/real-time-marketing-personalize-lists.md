...
In the code, you only specify the placeholder name. To set up the list, go to the **Personalize** tab in the Customer Insights - Journeys email designer:
...
To access the code generator, go to the **Personalize** tab in the Customer Insights - Journeys email designer:
