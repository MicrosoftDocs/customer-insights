...
> [!NOTE]
> Litmus must be enabled for your instance before you can use it. 
- To enable Litmus in Real-time journeys orgs only go to Feature switches > Email editor > Litmus integration. 
- To enable Litmus in Outbound and Real-time journeys orgs go to Default settings > Marketing emails > Enable Litmus integration.
