...
To reduce and eventually end outbound  marketing usage, we're applying a phased approach (below changes apply to outbound marketing only, real-time marketing is unaffected):
...
We are in phase 2 (as of July 17, 2025) starting with outbound marketing environments with no usage/low usage. If you have an approved extension, your environments will not be moved to phase 2 until after approved date. 
