...
As an existing outbound marketing customer, you must make a note of removal dates and transition to real-time journeys before that to avoid interruption. If you're using social posting or LinkedIn lead generation capabilities, note that they have been removed already and your ability to create new social posts or LinkedIn leads has been restricted already. Your data will still be available for reporting.
