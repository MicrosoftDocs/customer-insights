...
-	You can buy the add-ons for each model independently. If you are on the old model, you buy the old add-ons if you previously owned them. If you are on the new model, you buy the new add-ons. You cannot mix and match add-ons for the new model with the old model. 
