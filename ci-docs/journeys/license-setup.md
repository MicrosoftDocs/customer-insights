...
Depending on how you got your license there are different pathways to get a license on your tenant: 
...
- If you purchase through a reseller, partner, or our volume licensing channels there are various workflows in place that can take different amounts of time. Please conact your reseller, partner, or Microsoft sales representative for help if you don't see the license in **Your Products**. The product team cannot help until the license is on the tenant. 
- If you are redeeming internal usage rights (IUR)s through the Microsoft Partner Network subscription programs, [follow the instructions](https://learn.microsoft.com/partner-center/cloud-services#activate-a-subscription-for-the-first-time) to redeem your benefits, choose Dynamics 365 Marketing or Dynamics 365 Customer Insights and add the licenses to your tenant using the assigned promocodes from Partner Center.
...
- Dynamics 365 Customer Insights are tenant level licenses. If you have more than one tenant, you must purchase licenses for each tenant. 
...
- By June 30, 2024, if you own paid licenses there are no longer application installation limits for either **Customer Insights - Journeys (real-time only)** and **Customer Insights - Data** on your production and sandbox dataverse environments. 
...
Every time you’ve done a self-service trial, a license is created and never removed. As of September 2023, these listings are now a means to open the installation page via the **Manage** option and mean nothing more.
