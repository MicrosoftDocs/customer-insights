...
-	The installation management page allows you to install two times more than you are entitled to accomodate migration scenarios. If you need to install either application more than four times, you can buy an additional instance of the base license to get four more application installation entitlements per app.
