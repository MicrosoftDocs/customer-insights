...
-   As a tenant admin you can see what licenses are on your tenant by going to the [Microsoft Admin Center](https://www.admin.microsoft.com) > **Billing** > **Your Products**. Because the Customer Insights licenses are not seat based, that is you do not pay per user, you will not see them listed under **Licenses**. Only licenses where you pay per user and assign users show up under **Licenses**.
