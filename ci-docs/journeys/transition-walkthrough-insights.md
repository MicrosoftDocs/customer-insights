...
If you prefer not to use Fabric, we are working on a low-level solution that allows you to access Customer Insights - Journeys interaction data directly in storage and export it to your own third-party system. Using this solution, you would need to implement your own data pipelines to export and process the data (in Delta Lake format) based on your specific requirements and reporting systems.
