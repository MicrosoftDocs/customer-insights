...
- **Step analytics**: When you select any step in the journey, the right pane shows much information. There are three areas or groups:
    ...
    > This feature is currently available for one-time journeys with static audience. Support for repeating journeys is planned by December 16, 2024. Support for Ongoing journeys will be available in Feb 2025 release.
