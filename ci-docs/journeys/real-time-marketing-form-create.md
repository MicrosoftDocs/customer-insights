...
You can change the target audience using the **Audience** picker in the top right corner and adjust all other [settings](real-time-marketing-manage-forms.md#form-settings) for each individual form. To continue making your form, follow the next steps.
