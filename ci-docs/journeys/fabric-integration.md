...
| How can I access and export Customer Insights - Journeys data without using Fabric? | Microsoft Fabric remains the recommended way to access, work with and export Customer Insights - Journeys data, offering seamless integration and built-in analytics. However, we understand there are cases where customers prefer to use a third-party system for storage and processing. This article outlines how to access and export CI-J interaction data into your own storage, ensuring flexibility while following best practices: [Leveraging CI-J interaction data without Fabric](https://community.dynamics.com/blogs/post/?postid=75a63967-f115-f011-998a-7c1e525b5e9d). | 
