...
> [!NOTE]
> Forms created before the September 2023 release have only limited limited options to change form styling using Theme feature. You can enable more styles options by selecting button Enable in Theme section. This updates your form styles to the latest version compatible with the Theme feature.
