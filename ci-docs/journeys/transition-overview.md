...
| I provisioned a new org, or copied, migrated, restored an existing org, and don't see outbound marketing. | This is expected. Outbound marketing isn't included in new environments (also known as “orgs”) and can't be added. |
