...
- **Asset library**
    - Copy images from the outbound marketing file library to the Customer Insights - Journeys asset library. Learn more: [Export assets from outbound marketing to the asset library](upload-images-files.md#asset-library-features).
- **Customer journeys**
