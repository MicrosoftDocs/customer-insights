...
description: Manage event logistics in Dynamics 365 Customer Insights - Journeys, including vendors, hotels, room allocations, and reservations for attendees.
ms.date: 07/29/2026
ms.topic: article
author: alfergus
ms.author: alfergus
...
- **Events** > **Logistics** > **Hotels**: Enter and view details about specific hotel properties. You can associate each hotel record with a contact from your database, so you know who to call if you have any questions for the hotel. You can associate the hotel record with a hotel group (event vendor) if the property is part of a group. The hotel group and contact details are shown, if they're defined. Always specify the hotel's address as part of its record, so it's available when you need to contact the property. You can also view and add room allocations for the current hotel.
