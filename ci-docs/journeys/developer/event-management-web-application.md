...
|--|--|--|--|
|Sample Event Website| 1.60.0 (April-release)|- Performance improvements for event portal website. <br/>- Minor improvements and bug fixes.| [Download](https://download.microsoft.com/download/1/5/0/150757D0-2600-493B-8C9A-3213AD873A73/240419-EventWebsite.zip) |
