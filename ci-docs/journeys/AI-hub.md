...
> [!NOTE]
> AI Hub control is available to Admin user role by default. If you are using custom roles & permissions and want to add specific permissions for agent settings, the entity is *msdynmkt_agentsettings*. 
