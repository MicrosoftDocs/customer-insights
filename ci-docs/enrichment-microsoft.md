...
1. Select the **Customer data set** and choose the entity you want to enrich with data from Microsoft. You can select the *Customer* entity to enrich all your customer profiles or select a segment entity to enrich only customer profiles contained in that segment.

1. Map fields from your unified customer entity to define the demographic segment you want the system to use for enriching your customer data.

   > [!NOTE]
   > At least Date of Birth or Gender attributes are required. Country/Region and at least one of City (and State/Province) or Postal code are required. 
