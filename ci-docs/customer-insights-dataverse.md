...
1. If you have Dynamics 365 Marketing installed on the Dataverse environment, and you have [it connected to your Customer Insights environment](/dynamics365/marketing/real-time-marketing-ci-profile), remove this connection first. Otherwise, skip this step and proceed to #4 below.
    1. Go to **Tables**.
