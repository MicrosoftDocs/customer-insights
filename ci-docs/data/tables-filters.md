...
> [!NOTE]
> If you [explore a specific table's data](tables.md#explore-a-specific-tables-data), the full, unfiltered data displays. If you export a source table ingested in .csv or .parquet format, the export includes the full, unfiltered data.
