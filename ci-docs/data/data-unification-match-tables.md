...
1. In the **Add rule** pane, configure the conditions for the rule.
   ...
   - **Precision**: Set the level of precision to apply for this condition. [Precision is used with fuzzy matching](data-unification-match-fuzzy.md), and determines how close two strings need to be in order to be considered a match.
