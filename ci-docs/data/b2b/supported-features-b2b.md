...
> [!NOTE]
> This documentation is for previously-created B2B environments, it isn't supported for new enviornments. B2B won't be updated with new features being added to the standard version of Customer Insights - Data.
