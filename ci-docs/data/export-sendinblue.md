...
description: Export segments to Sendinblue and reach specific customer groups with targeted email marketing. Follow the steps to connect, configure, and run your export.
ms.date: 07/24/2026
