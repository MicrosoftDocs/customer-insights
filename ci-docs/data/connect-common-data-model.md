...
- If you have setup Azure Private Link on your storage you cannot connect to the storage without private link (even if you enabled public network access from all networks)
