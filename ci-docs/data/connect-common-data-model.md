...
- If your data lake currently has any private link connections to it, then CI-Data must also connect using a private link, regardless of the network access setting.
