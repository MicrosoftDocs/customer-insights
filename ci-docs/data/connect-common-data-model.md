...
If the schema of the source data is changed after ingesting the data, a schema mismatch or data mismatch error appears asking you to update the data source connection. These errors can be seen in the task details. Schema changes include updates to columns, column names, and column data types.
