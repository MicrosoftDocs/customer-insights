...
Dynamics 365 Customer Insights - Data provides an option to connect to an Azure Data Lake Storage account by using an Azure service principal.
...
2. Create the service principal with the Azure AD PowerShell module.
