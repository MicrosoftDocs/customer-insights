...
1. Select the vertical ellipsis (**&vellip;**) next to a model to view the actions you can take.
   ...
   - **Delete** a workflow. The table that you used to create the workflow isn't deleted.

## View the results

You store results from a workflow in the **Output table name** you define. View it from the [**Data** > **Tables** > **Output**](../tables.md) page or by using [API access](../apis.md).
...
1. Replace `<custom model output table>` with the table name you provide during the **Model name** step.
