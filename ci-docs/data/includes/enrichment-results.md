After a completed [enrichment run](../enrichment-manage.md#run-or-refresh-enrichments), select the enrichment to review the [results](../enrichment-manage.md#view-enrichment-results). 
