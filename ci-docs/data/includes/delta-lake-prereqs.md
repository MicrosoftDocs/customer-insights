...
- Customer Insights - Data supports Delta tables with a `minReaderVersion` of 3 or earlier, subject to the listed feature support. Learn more: [Supported Databricks features](../connect-delta-lake.md#supported-databricks-features-and-versions).
