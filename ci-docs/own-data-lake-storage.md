...
1. Choose if you want to use Azure Private Link to connect to the storage account and [create the connection to Private Link](security-overview.md#set-up-an-azure-private-link) with a two-step process.
