After a completed [enrichment run](../enrichment-hub.md#run-or-refresh-enrichments), select the enrichment to review the [results](../enrichment-hub.md#view-enrichment-results). 
