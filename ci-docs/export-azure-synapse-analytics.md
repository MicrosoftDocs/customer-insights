...
- [Power Query datasources](connect-power-query.md) as input tables are currently supported only if your Customer Insights environment stores data in your [own Azure Data Lake Storage](own-data-lake-storage.md).
