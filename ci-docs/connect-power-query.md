...
2. Select the vertical ellipsis (:::image type="icon" source="media/ellipsis_icon.png":::) next to the data source you want to change and select **Edit** from the dropdown menu.
