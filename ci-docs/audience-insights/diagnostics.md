...
| `properties.identifier`                      | No       | Yes  | For OperationType = `Export` the identifier is the guid of the export configuration. For others it is the name of the Entity                                                                                                                                                       |
| `properties.friendlyName`                    | No       | Yes  | User friendly Name of the Export or The Entity                                                                                                                                                                                                                                     |
| `properties.error`                           | No       | Yes  | Optional. Error Message with more detals                                                                                                                                                                                                                                           |
...
| `properties.additionalInfo.AffectedEntities` | No       | Yes  | Optional. For OperationType `Export` only. Identifies the kind of the export. List of configured entities in the export.                                                                                                                                                           |
