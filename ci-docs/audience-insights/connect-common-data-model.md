...
5. You can choose between a resource-based option and a subscription-based option. FOr more information, see [Connect audience insights to an Azure Data Lake Storage Gen2 account with an Azure service principal](connect-ADLS-SPN.md). Enter the **Container** information and select **Next**.
