...
## Setup connection to Azure Data Lake Storage Gen2 (preview)
...
1. In **Connection for export** choose a connection from the **Azure Data Lake** section. If you don't see this section name, there are no connections of this type available to you.
