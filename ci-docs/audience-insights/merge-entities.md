...
description: "Review and edit how source data is combined into unified customer fields."
ms.date: 04/08/2022
...
Review the list of fields that will be unified under the **Customer fields** tab of the table.

1. You can:
   - [Rename](#rename-fields)
   - [Exclude](#exclude-fields)
   - [Move up or down](#change-the-order-of-fields)
   - [Combine fields](#combine-fields-manually) or 
